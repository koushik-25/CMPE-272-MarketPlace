...
?>
<?php
        setcookie("6year",time());
        #echo $_COOKIE["1year"];
        if(!isset($_COOKIE["6year-plan"]))
        {
        setcookie("6year-plan",0);
        }
        

        setcookie("6year-plan",$_COOKIE["6year-plan"]+1);
?>
<!DOCTYPE html>
<html>
   <head>
...
html { 
  ...
  background-size: cover;
   ...
   <body>
      <h1>Gift your children International travel.New.</h1>
      <?php 
    $productName = 'year6'; #keep it same as url for ex: http://localhost:8009/cosmocast/Services/product1.php use product name as product1
